...
export enum MediaEdgeDetectMethods {
  ...
  HUE = 'HUE',
  LIGHTEN = 'LIGHTEN',
  LIGHTEN_INTENSITY = 'LIGHTEN_INTENSITY',
...
export const MimetypesToExtension: Record<Mimetypes, string> = Object.freeze({
  ...
  [Mimetypes.AUDIO_X_MATROSKA]: 'mka',
  [Mimetypes.AUDIO_X_WAV]: 'wav',
  ...
  [Mimetypes.VIDEO_X_MATROSKA]: 'mkv',
...
export enum TTSVoices {
  ...
  SAPI_MICROSOFT_EN_FEMALE_MARY = 'SAPI_MICROSOFT_EN_FEMALE_MARY',
  SAPI_MICROSOFT_EN_MALE_MIKE = 'SAPI_MICROSOFT_EN_MALE_MIKE',
  SAPI_MICROSOFT_EN_MALE_SAM = 'SAPI_MICROSOFT_EN_MALE_SAM',
  SAPI_SCANSOFT_EN_MALE_MLG_DANIEL = 'SAPI_SCANSOFT_EN_MALE_MLG_DANIEL',
...
export const TTSVoicesToText = Object.freeze({
  ...
  [TTSVoices.SAPI_MICROSOFT_EN_FEMALE_MARY]: 'SAPI Microsoft English Female Mary',
  [TTSVoices.SAPI_MICROSOFT_EN_MALE_MIKE]: 'SAPI Microsoft English Male Mike',
  [TTSVoices.SAPI_MICROSOFT_EN_MALE_SAM]: 'SAPI Microsoft English Male Sam',
  [TTSVoices.SAPI_SCANSOFT_EN_MALE_MLG_DANIEL]: 'SAPI ScanSoft English Male MLG Daniel',
