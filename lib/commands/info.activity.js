                ...
                if (presence) {
                    ...
                    if (activityId in activities) {
                        ...
                        if (assets && assets.smallText) {
                            embed.setFooter(assets.smallText, assets.smallImageUrl || undefined);
                        }
                        const timestamps = activity.timestamps;
                        if (timestamps) {
                            const elapsed = utils_1.formatTime(Math.max(timestamps.elapsedTime, 0));
                            const total = utils_1.formatTime(timestamps.totalTime);
                        ...
                        if (activity.isOnSpotify) {
                            ...
                            if (activity.details) {
                                ...
                                description.push(activity.spotifyTrackUrl);
                            }
